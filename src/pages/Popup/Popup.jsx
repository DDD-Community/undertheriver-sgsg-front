...
import TagInput from '../Popup/components/tagInput';
...
const Popup = (props) => {
  ...
  const googleLogin = () => {
    ...
    location.href = `https://api.sgsg.space/oauth2/authorization/google?redirect_uri=`;
  };
  ...
  return (
    ...
    >
      ...
      <div onClick={googleLogin}>로그인</div>
      {!submitFlag ? (
        <>
